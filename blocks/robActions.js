...
Blockly.Blocks['robActions_brickLight_on'] = {
    ...
    init: function () {
        ...
        } else if (this.workspace.device === 'raspberrypi') {
        ...
        if (this.workspace.device === 'arduino' || this.workspace.device === 'nano33ble' || this.workspace.device === 'calliope' || this.workspace.device === 'sensebox'
            || this.workspace.device === 'festobionic' || this.workspace.device === 'raspberrypi') {
            var dropDownPorts;
...
Blockly.Blocks['robActions_led_on'] = {
    ...
    init: function () {
        ...
        if (this.workspace.device === 'arduino' || this.workspace.device === 'nano33ble' || this.workspace.device === 'sensebox' || this.workspace.device === 'raspberrypi') {
